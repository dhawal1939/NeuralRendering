...
import config
from dataset.uv_dataset import UVDataset, UVDatasetSH,UVDatasetSHLow
from model.pipeline import PipeLine, PipeLineSH,PipeLineSHLow
...
def main():
    ...
    dataset = UVDatasetSHLow(args.data+'/train/', args.train, args.croph, args.cropw, args.view_direction)
    dataloader = DataLoader(dataset, batch_size=args.batch, shuffle=True, num_workers=4)

    test_dataset = UVDatasetSHLow(args.data+'/test/', args.train, args.croph, args.cropw, args.view_direction)
    ...
    if args.load:
        ...
        model = PipeLineSHLow(args.texturew, args.textureh, args.texture_dim, args.use_pyramid, args.view_direction)
        step = 0
